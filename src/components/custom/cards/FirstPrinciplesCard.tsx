...
const FirstPrinciplesCard = () => {
  return (
    <div className="w-[91.12rem]  h-[57.31rem] rounded-[20px]  flex pt-[7.375rem] justify-center bg-black">
      <div className="bg-bgLightYellow relative max-w-[76.125rem] h-[730px] rounded-[20px]  text-text-black  border-4 border-borderYellow pb-[70px] px-[2.5rem] pt-[9.25rem]">
        <Image
          height={180}
          width={180}
          ...
          <div className="flex items-center  gap-2 text-text-red">
            ...
            <p>
              ...
              <span className="font-bold">
                HARD truth - Most schools don't teach this!
              </span>
            </p>
          </div>
          <p className="pl-10 font-bold text-black">
